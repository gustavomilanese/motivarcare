      ...
      >
        ...
        <View style={[styles.sheet, { paddingBottom: insets.bottom + 16 }]}>
          ...
          <Text style={styles.sub}>
            Contanos el motivo. Si corresponde, se te devolverá el crédito.
          </Text>
          <TextInput
            value={reason}
          ...
          <PrimaryButton label="Confirmar cancelación" loading={loading} variant="danger" onPress={() => void onSubmit()} />
