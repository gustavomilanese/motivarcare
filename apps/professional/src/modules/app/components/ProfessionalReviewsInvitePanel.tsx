  ...
  return (
    <section className="pro-profile-studio__reviews-invite" aria-labelledby="pro-reviews-invite-title">
      ...
      <p className="pro-profile-studio__reviews-invite-copy">
        {t(props.language, {
          es: `Las opiniones las dejan pacientes con al menos ${MIN_COMPLETED_SESSIONS_FOR_PROFESSIONAL_REVIEW} sesiones realizadas en MotivarCare. Compartí este enlace para que puedan calificarte desde el portal paciente.`,
