...
export const PROFESSIONAL_LANGUAGE_CHOICES: LanguageChoice[] = [
...
export function PortalPreferencesModal(props: {
  ...
  const languageChoices = props.languageChoices ?? PROFESSIONAL_LANGUAGE_CHOICES;
  ...
  return (
    <div className="session-modal-backdrop" role="presentation" onClick={props.onClose}>
      <section
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="pro-preferences-modal-title"
        onClick={(event) => event.stopPropagation()}
      >
        <header className="preferences-modal-header">
          <div>
            <h2 id="pro-preferences-modal-title">
