...
export const SECURITY_AUDIT_CATEGORY = {
  ...
  AUTH_LOGIN_TURNSTILE_FAILED: "AUTH_LOGIN_TURNSTILE_FAILED",
  AUTH_LOGIN_TURNSTILE_MISSING: "AUTH_LOGIN_TURNSTILE_MISSING",
  AUTH_REGISTER_ADMIN_BLOCKED: "AUTH_REGISTER_ADMIN_BLOCKED"
} as const;
