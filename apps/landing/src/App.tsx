...
> = {
  es: {
    heroTitle: "Cuida tu salud mental con MotivarCare",
    patientHeadline: "Terapia online desde tu celular o tu notebook.",
    patients: "Pacientes",
    psychologists: "Psicologos",
    professionalHeadline: "Conecta con nuevos pacientes con una administracion super sencilla",
    patientCopy: "Una experiencia simple para reservar, entrar a sesion y continuar el proceso.",
    professionalCopy: "Una plataforma disenada para psicologos que quieren ampliar su practica, gestionar sesiones online y trabajar con mayor libertad.",
    ...
    reviewsNavNext: "Ver siguientes reviews",
    blogTitleA: "Blog de psicologia de MotivarCare:",
    blogTitleB: "articulos para tu bienestar emocional",
    ...
    blogSearch: "Busca por tematica...",
    found: "articulos encontrados",
    readMore: "Leer mas",
    page: "Pagina",
    of: "de",
    prev: "Anterior",
    next: "Siguiente",
    close: "Cerrar articulo",
    like: "Like",
    unlike: "Quitar like",
    comment: "Comentar",
    ...
    publish: "Publicar",
    articlePrev: "Articulo anterior",
    articleNext: "Articulo siguiente",
    usefulLinks: "Vinculos utiles",
    likesLabel: "likes",
    yourUser: "Tu usuario",
    company: "Compania",
    useful: "Util",
    supportLine: "Linea 988 de prevencion del suicidio",
    patientPortalShort: "Portal pacientes",
    professionalPortalShort: "Portal psicologos",
    adminPortalShort: "Portal admin",
    footerLanguage: "Espanol",
    footerBrand: "La oportunidad de cuidar el bienestar mental deberia estar al alcance de todos.",
    terms: "Terminos y condiciones",
    privacy: "Politica de privacidad",
    acceptableUse: "Politica de uso aceptable",
    rights: "Todos los derechos reservados.",
    metricsAria: "Metricas de MotivarCare",
    cardsAria: "Opciones de plataforma",
    reviewsAria: "Resenas de usuarios",
    blogAria: "Blog de salud mental",
    categoriesAria: "Categorias de blog",
    myAccount: "Mi cuenta",
...
const metricsByLanguage: Record<Language, PlatformMetric[]> = {
  es: [
    {
      id: "psychologists",
      title: "Mas de 1.200 psicologos certificados",
      description: "Profesionales seleccionados y matriculados."
    },
    {
      id: "sessions",
      title: "+100.000 sesiones realizadas",
      description: "Miles de personas ya encontraron apoyo."
    },
    {
      id: "wellbeing",
      title: "8 de cada 10 pacientes reportan mejora en su bienestar",
      description: ""
    }
  ],
  en: [
    {
      id: "psychologists",
      title: "More than 1,200 certified psychologists",
      description: "Selected and licensed professionals."
    },
    {
      id: "sessions",
      title: "+100,000 sessions completed",
      description: "Thousands of people have already found support."
    },
    {
      id: "wellbeing",
      title: "8 out of 10 patients report improvements in wellbeing",
      description: ""
    }
  ],
  pt: [
    {
      id: "psychologists",
      title: "Mais de 1.200 psicologos certificados",
      description: "Profissionais selecionados e registrados."
    },
    {
      id: "sessions",
      title: "+100.000 sessoes realizadas",
      description: "Milhares de pessoas ja encontraram apoio."
    },
    {
      id: "wellbeing",
      title: "8 de cada 10 pacientes relatam melhora no bem-estar",
      description: ""
    }
  ]
};
...
const initialReviews: ReviewItem[] = [
  {
    ...
    name: "Melanie",
    role: "Paciente",
    relativeDate: "hace 19 dias",
    text: "Comence hace un tiempo mi terapia y estoy muy contenta. Siento atencion real en cada sesion.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    name: "Virginia",
    role: "Paciente",
    relativeDate: "hace 24 dias",
    text: "La comunicacion es clara y me siento a gusto. Todo el proceso de reserva y pago es simple.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    name: "Paulo",
    role: "Paciente",
    relativeDate: "hace 25 dias",
    text: "Excelente experiencia. Se nota cercania profesional y seguridad desde la primera sesion.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    name: "Jose",
    role: "Paciente",
    relativeDate: "hace 26 dias",
    text: "Para mi fue una profesional all stars. Muy receptiva y humana para trabajar temas complejos.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    name: "Lucia",
    role: "Paciente",
    relativeDate: "hace 14 dias",
    text: "Me senti escuchada desde el primer contacto. El proceso de agenda y seguimiento funciona excelente.",
    rating: 5,
    avatar:
      "https://images.pexels.com/photos/712521/pexels-photo-712521.jpeg?auto=compress&cs=tinysrgb&w=200",
    accent: "#3d7cc9"
  },
  {
    id: "martin",
    name: "Martin",
    role: "Paciente",
    relativeDate: "hace 11 dias",
    text: "La sesion por video fue estable y sin cortes. Muy buena experiencia general.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    name: "Camilo",
    role: "Paciente",
    relativeDate: "hace 8 dias",
    text: "Muy claro el flujo para reservar y pagar. Todo esta ordenado y sin confusiones.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    name: "Sergio",
    role: "Paciente",
    relativeDate: "hace 5 dias",
    text: "Me gusto la puntualidad y la calidad del encuentro. Recomiendo totalmente.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    name: "Tomas",
    role: "Paciente",
    relativeDate: "hace 3 dias",
    text: "Excelente seguimiento entre sesiones. Se nota que esta pensado para pacientes reales.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    role: "Paciente",
    relativeDate: "hace 3 dias",
    text: "Gran experiencia, me senti acompanada en todo momento. Muy recomendable.",
    rating: 5,
    avatar:
  ...
  },
  {
    ...
    name: "Nicolas",
    role: "Paciente",
    relativeDate: "hace 2 dias",
    text: "Me ayudo mucho tener una opcion online flexible para organizar mis horarios.",
    rating: 5,
    avatar:
...
const blogContentByLanguage: Record<"en" | "pt", Record<string, LocalizedPostContent>> = {
  en: {
    "blog-1": {
      ...
      subtitle: "Leonardo Saguerela · November 17, 2025 · 6 min read",
    ...
    "blog-4": {
      ...
      subtitle: "Leonardo Saguerela · April 4, 2025 · 6 min read",
    ...
    "blog-8": {
      ...
      subtitle: "Leonardo Saguerela · February 22, 2026 · 7 min read",
    ...
    "blog-11": {
      ...
      subtitle: "Leonardo Saguerela · March 7, 2026 · 7 min read",
    ...
    "blog-12": {
      ...
      subtitle: "Leonardo Saguerela · February 26, 2026 · 7 min read",
    ...
    "blog-16": {
      ...
      subtitle: "Leonardo Saguerela · December 2, 2025 · 8 min read",
    ...
    "blog-17": {
      ...
      subtitle: "Daniela Castro · March 3, 2026 · 7 min read",
    ...
    "blog-18": {
      ...
      subtitle: "Leonardo Saguerela · March 4, 2025 · 6 min read",
  ...
  pt: {
    "blog-1": {
      ...
      subtitle: "Leonardo Saguerela · 17 de novembro de 2025 · 6 min de leitura",
    ...
    "blog-4": {
      ...
      subtitle: "Leonardo Saguerela · 4 de abril de 2025 · 6 min de leitura",
    ...
    "blog-8": {
      ...
      subtitle: "Leonardo Saguerela · 22 de fevereiro de 2026 · 7 min de leitura",
    ...
    "blog-11": {
      ...
      subtitle: "Leonardo Saguerela · 7 de marco de 2026 · 7 min de leitura",
    ...
    "blog-12": {
      ...
      subtitle: "Leonardo Saguerela · 26 de fevereiro de 2026 · 7 min de leitura",
    ...
    "blog-16": {
      ...
      subtitle: "Leonardo Saguerela · 2 de dezembro de 2025 · 8 min de leitura",
    ...
    "blog-17": {
      ...
      subtitle: "Daniela Castro · 3 de marco de 2026 · 7 min de leitura",
    ...
    "blog-18": {
      ...
      subtitle: "Leonardo Saguerela · 4 de marco de 2025 · 6 min de leitura",
...
const blogPosts: BlogPost[] = [
  {
    id: "blog-1",
    title: "Ejercicios para la ansiedad: 5 tecnicas de respiracion que ayudan",
    subtitle: "Leonardo Saguerela · 17 de noviembre de 2025 · 6 min de lectura",
    slug: "ejercicios-ansiedad-tecnicas-respiracion",
    excerpt: "Cinco tecnicas de respiracion practicas para bajar activacion fisica y recuperar control.",
    category: "Ansiedad",
    coverImage:
      "https://images.pexels.com/photos/3811082/pexels-photo-3811082.jpeg?auto=compress&cs=tinysrgb&w=1600",
    authorName: "Leonardo Saguerela",
  ...
  {
    id: "blog-4",
    title: "5 tecnicas para superar el miedo a los temblores",
    subtitle:
      "Leonardo Saguerela · 4 de abril de 2025 · 6 min de lectura\nPsicologo General Sanitario (Homologacion) - Ministerio de Universidades, Espana - Matriculado por el Colegio Oficial de Psicologos de Catalunya. Licenciado en Psicologia (UBA, 2004)",
    slug: "tecnicas-superar-miedo-temblores",
    excerpt: "Tecnicas concretas para comprender los temblores por ansiedad y recuperar seguridad corporal.",
    category: "Fobias",
    coverImage:
    ...
    status: "published",
    featured: false,
    seoTitle: "Miedo a los temblores: tecnicas utiles | MotivarCare",
  ...
  {
    id: "blog-5",
    title: "Como poner limites sin culpa en relaciones cercanas",
  ...
  },
  {
    ...
    subtitle: "Leonardo Saguerela · 22 de febrero de 2026 · 7 min de lectura",
  ...
  },
  {
    ...
    subtitle: "Leonardo Saguerela · 7 de marzo de 2026 · 7 min de lectura",
  ...
  {
    id: "blog-13",
    title: "Como acompanar a un familiar con depresion",
  ...
  },
  {
    ...
    status: "published",
    featured: false,
    seoTitle: "Como elegir psicologo online: preguntas clave | MotivarCare",
  ...
  },
  {
    ...
    subtitle: "Leonardo Saguerela · 2 de diciembre de 2025 · 8 min de lectura",
  ...
  },
  {
    ...
    subtitle: "Daniela Castro · 3 de marzo de 2026 · 7 min de lectura",
  ...
  {
    id: "blog-18",
    title: "Como prepararte para tu primera sesion de terapia online",
    subtitle: "Leonardo Saguerela · 4 de marzo de 2025 · 6 min de lectura",
    ...
    status: "published",
    featured: false,
    seoTitle: "Primera sesion de terapia online: guia breve | MotivarCare",
  ...
  "blog-1": [
    {
      ...
      text: "Me sirvio mucho la parte de alargar la exhalacion. Lo aplique antes de dormir.",
      createdAt: "2026-03-01",
      likes: 18,
      reply: {
        author: "Equipo MotivarCare",
  ...
  "blog-2": [
    {
      ...
      text: "Gran articulo. Me ayudo a bajar la autoexigencia de cambiar todo de golpe.",
  ...
  "blog-13": [
    {
      ...
      text: "Muy util para familiares que no saben como acompanar.",
...
const categoryQuoteByCategory: Record<string, { text: string; author: string }> = {
  Ansiedad: {
    ...
    author: "Daniela Castro, psicologa clinica"
  },
  Autoestima: {
...
export function App() {
  ...
  const openPostBody = openPost
    ? language !== "es"
      ...
      : openPost.id === "blog-12"
      ? openPost.body
      : `${openPost.body}\n\n${categoryBodyAppendix[openPost.category] ?? categoryBodyAppendix.Guia}\n\n## Desarrollo clinico y herramientas aplicables\nEn consulta, uno de los puntos mas importantes es transformar comprension en acciones sostenibles.\n\nEso incluye definir objetivos concretos, registrar avances y revisar obstaculos sin caer en autojuicio.\n\nCuando el proceso terapeutico se combina con practicas diarias simples, la mejora suele ser mas estable en el tiempo.\n\n## Implementacion semanal sugerida\nSemana 1: observacion y registro de situaciones clave.\n\nSemana 2: primera herramienta de regulacion y ajuste de rutina.\n\nSemana 3: consolidacion, evaluacion de avances y redefinicion de metas.\n\n## Cita destacada\n> ${categoryQuoteByCategory[openPost.category]?.text ?? categoryQuoteByCategory.Guia.text}\n> \n> ${categoryQuoteByCategory[openPost.category]?.author ?? categoryQuoteByCategory.Guia.author}`
    : "";
        ...
        <section className="cards-stack" aria-label={t.cardsAria}>
          <article className="card card-primary">
            <div className="card-copy">
              ...
              <a href={LEGACY_PATIENT_URL} target="_blank" rel="noreferrer">
          ...
          <article className="card card-secondary">
            <div className="card-copy compact">
              ...
              <a className="card-link-break" href={LEGACY_PROFESSIONAL_URL} target="_blank" rel="noreferrer">
          ...
          <article className="blog-modal" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="blog-modal-body">
              {openPostBody.split("\n\n").map((paragraph, index) => {
                ...
                if (paragraph.startsWith("> ")) {
                  return <blockquote key={`q-${index}`}>{paragraph.replace("> ", "")}</blockquote>;
                }
          ...
          <article className="blog-modal account-modal" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="account-modal-body">
              ...
              <div className="account-grid">
                <a href={LEGACY_PATIENT_URL} target="_blank" rel="noreferrer" onClick={() => setIsAccountOpen(false)}>
                  {t.accountPortalPatient}
                </a>
                <a href={LEGACY_PROFESSIONAL_URL} target="_blank" rel="noreferrer" onClick={() => setIsAccountOpen(false)}>
                  {t.accountPortalProfessional}
                </a>
                <a href={LEGACY_ADMIN_URL} target="_blank" rel="noreferrer" onClick={() => setIsAccountOpen(false)}>
      ...
      <footer className="footer">
        <div className="footer-top">
          ...
          <section className="footer-col">
            ...
            <a href={LEGACY_PROFESSIONAL_URL} target="_blank" rel="noreferrer">
              {t.professionalPortalShort}
            </a>
            <a href={LEGACY_ADMIN_URL} target="_blank" rel="noreferrer">
              {t.adminPortalShort}
            </a>
          </section>
        </div>
